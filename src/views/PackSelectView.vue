    ...
    <div class="container mx-auto p-2 text-center md:max-w-md">
        ...
        <div class="player-select min-w-min">
            ...
            <div class="flex flex-col space-y-2 py-2">
                <div v-for="pack in packStore.packs" :key="pack.id"
                    class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                    <input @change="e => change(pack.id, e.target.checked)" :id="pack.name" type="checkbox"
                        :checked="pack.enabled" name="bordered-checkbox"
